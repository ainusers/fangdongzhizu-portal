	...
	<view class="layout">
		<view class="title">
			<view class="item zan" @click="goLike()">
				<view class="top">
					<uni-icons type="heart" size="35" color="#1183fb"></uni-icons>
			...
			<view class="item guanzhu" @click="goBookMark()">
				<view class="top">
					<uni-icons type="star" size="40" color="#1183fb"></uni-icons>
			...
			<view class="item pinglun" @click="goComment()">
				<view class="top">
					<uni-icons type="chat" size="40" color="#1183fb"></uni-icons>
