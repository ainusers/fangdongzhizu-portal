  ...
  <view class="abslrtb flex-column a-center wrap">
    ...
    <view class="form">
      <view class="flex a-center form-item">
        ...
        <view class="flex-1">
          <input placeholder-class="placeholder" class="qui-input" type="number" value="" v-model="phone"
                 @input="inputPhone" placeholder="请输入手机号"/>
        </view>
      </view>
      <!-- 图形码 -->
      <imgCode ref="imgCode"/>
      <view class="flex a-center form-item">
        ...
        <view class="label_fgs"></view>
        <view class="flex-1">
          <input placeholder-class="placeholder" class="qui-input" type="number" value="" maxlength="6" v-model="code"
                 placeholder="请输入验证码"/>
        </view>
        <view>
